	...
	<section class="estance">
		<div class="block_ectance">
			<div class="reg">
				...
				<form action="processing/processind_registration.php" method="POST">
					<input type="text" class="text_input" name="name" placeholder="Введите имя" required><br><br>
					...
					<input type=submit value="Регистрация" class="button_contacts">  
